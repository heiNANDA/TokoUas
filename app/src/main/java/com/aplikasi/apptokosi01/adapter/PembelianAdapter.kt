...
class PembelianAdapter(val listProduk: List<Produk>): RecyclerView.Adapter<PembelianAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PembelianAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_pembelian, parent, false)
        return PembelianAdapter.ViewHolder(view)
    }

    override fun onBindViewHolder(holder: PembelianAdapter.ViewHolder, position: Int) {
        ...
        holder.txtHarga.text = numberFormat.format(produk.harga.toDouble()).toString().toString()
